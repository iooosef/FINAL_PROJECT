...
# menus
        ...
        viewplannMenu.add_command(label="View Plan", command = ViewPlan)
...
# starttime
        ...
        self.hours_start = Entry(newmain, textvariable = hour1, font=('Comic Sans MS', 11), width=6, fg='black',borderwidth=2)
        self.hours_start.place(anchor=NW, x=88, y=460)
        self.minutes_start = Entry(newmain, textvariable = min1, font=('Comic Sans MS', 11), width=6, fg='black',borderwidth=2)
        self.minutes_start.place(anchor=NW, x=206, y=460)
        self.seconds_start = Entry(newmain, textvariable = sec1, font=('Comic Sans MS', 11), width=6, fg='black',borderwidth=2)
...
# endtime
        ...
        self.hours_end = Entry(newmain, textvariable = hour2, font=('Comic Sans MS', 11), width=6, fg='black',borderwidth=2)
        self.hours_end.place(anchor=NW, x=88, y=545)
        self.minutes_end = Entry(newmain, textvariable = min2, font=('Comic Sans MS', 11), width=6, fg='black',borderwidth=2)
        self.minutes_end.place(anchor=NW, x=206, y=545)
        self.seconds_end = Entry(newmain, textvariable = sec2, font=('Comic Sans MS', 11), width=6, fg='black',borderwidth=2)
...
# Buttons
        self.button = Button(newmain ,width=10, bg='#ffd39b',fg='black', text='Submit', font=('Comic Sans MS',10),borderwidth=0, border=3,command= evaluation)
...
class ImageWindow_Login():
    def __init__(self):
        ...
        self.button = Button(self.root, text="Go back", font=('Arial', 7), fg='black', width=9, borderwidth=2, command=self.root.destroy)
        self.button.pack(anchor='nw', pady=1, padx=5)
        mssg1.pack()
        ...
        self.button = Button(img, text="Go back", font=('Arial', 7), fg='black', width=9, borderwidth=2, command=img.destroy)
        self.button.pack(anchor='nw', pady=1, padx=5)
        self.root.mainloop()
